...
def randid():  # 身份证
    ...
    #          '44', '45', '46', '50', '51', '52', '53', '54', '61', '62', '63', '64', '65']  # 全国区域代码
    # province_num = randint(1, len(list1) - 1)
    # str_id.append(list1[province_num])
    # city_num = randint(10, 19)
    # county_num = randint(10, 19)
    # str_id.append(str(city_num))
    # str_id.append(str(county_num))
    id_year = randint(1985, 2003)
...
# 手机号
phone = "".join(randomnum())
# 身份证号
idcardId = "".join(randid())
# 姓名
name = "".join(randname())
